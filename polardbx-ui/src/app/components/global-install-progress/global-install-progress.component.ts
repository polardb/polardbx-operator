...
export class GlobalInstallProgressComponent implements OnInit {
  tasks: InstallTask[] = [];

  constructor(
    private service: GlobalInstallProgressService,
    private router: Router
  ) {}

  ngOnInit(): void {
    this.service.getTasks().subscribe(list => this.tasks = list);
  }
