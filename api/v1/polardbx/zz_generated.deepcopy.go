...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CdcGroup) DeepCopyInto(out *CdcGroup) {
	*out = *in
	if in.Template != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CdcGroup.
func (in *CdcGroup) DeepCopy() *CdcGroup {
	if in == nil {
		return nil
	}
	out := new(CdcGroup)
...
func (in *ColumnarConfig) DeepCopyInto(out *ColumnarConfig) {
	*out = *in
	...
	if in.ColumnarDataFileStorage != nil {
		in, out := &in.ColumnarDataFileStorage, &out.ColumnarDataFileStorage
		*out = make([]FileStorageInfo, len(*in))
		copy(*out, *in)
	}
}
