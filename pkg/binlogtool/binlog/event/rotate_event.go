...
func (e *RotateEvent) Layout(version uint32, code byte, fde *FormatDescriptionEvent) *layout.Layout {
	return layout.Decl(
		layout.If(version != spec.V1, layout.Number(&e.Pos)),
		layout.Bytes(layout.Infinite(), &e.Name),
	)
}
